...
const Feed: React.FC = () => {
  ...
  return (
    <div className="h-[calc(100vh-64px)] overflow-y-auto snap-y snap-mandatory scroll-smooth hide-scrollbar p-6 lg:p-10">
      <LoginPromptModal 
      ...
      {MOCK_EVENTS_DATA.map((event, index) => (
        <div 
          key={event.id}
          className="feed-item relative w-full h-[calc(100vh-160px)] rounded-[40px] overflow-hidden bg-black shadow-2xl mb-10 snap-start flex flex-col justify-end border border-white/5"
        >
          {/* Background Image */}
