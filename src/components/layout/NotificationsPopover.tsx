      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-[-64px] sm:right-0 mt-3 w-[calc(100vw-32px)] sm:w-80 lg:w-96 max-w-[360px] sm:max-w-none bg-white rounded-3xl shadow-2xl border border-outline-variant p-2 flex flex-col z-50 overflow-hidden"
          >
